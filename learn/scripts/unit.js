export let lessons = [
                ...
                questions: [
    {
        ...
        explain: "Thế điện cực chuẩn ký hiệu là E° và đo ở điều kiện chuẩn."
    },
    {
        ...
        explain: "Điện cực hiđro chuẩn (H⁺/H₂) được quy ước E° = 0 V và dùng làm điện cực so sánh."
    },
    {
        ...
        explain: "Cặp 2H⁺/H₂ được chọn làm mốc chuẩn với E° = 0 V."
    },
    {
        ...
        explain: "Cặp Cu²⁺/Cu có E° > 0, nghĩa là Cu khó bị oxi hóa hơn H₂."
    },
    {
    ...
    },
    {
        ...
        explain: "Na⁺/Na có E° = −2,71 V, nhỏ nhất trong các cặp đã cho."
    },
    {
        question: "Trong dãy điện hóa Mg²⁺/Mg; H₂O/H₂, OH⁻; 2H⁺/H₂; Ag⁺/Ag, cặp nào có E° lớn nhất?",
        img: "none",
        answers: [
            "Ag⁺/Ag",
            "2H⁺/H₂",
    ...
    {
        question: "Phát biểu đúng về phản ứng: Cu + 2Ag⁺ → Cu²⁺ + 2Ag là",
        img: "none",
        answers: [
    ...
    {
        question: "Phát biểu không đúng về phản ứng: Cu + 2Fe³⁺ → Cu²⁺ + 2Fe²⁺ là",
        img: "none",
        answers: [
        ...
        explain: "Cu²⁺ không oxi hóa mạnh hơn Fe³⁺, vì Fe³⁺ oxi hóa Cu thành Cu²⁺."
    }
]
                ...
                questions: [
    {
        ...
        explain: "Trong dãy điện hoá, khi đi từ trái sang phải, E° tăng dần nên tính oxi hoá của ion kim loại cũng tăng dần."
    },
    {
        question: "(SBT – KNTT) Trong nước, thế điện cực chuẩn của kim loại M²⁺/M càng lớn thì dạng khử có tính khử..(1).. và dạng oxi hoá có tính oxi hoá..(2).. Cụm từ cần điền vào (1) và (2) lần lượt là",
        img: "none",
        answers: [
        ...
        explain: "E° càng lớn → ion M²⁺ dễ nhận e⁻ hơn (oxi hoá mạnh hơn), còn M khó nhường e⁻ hơn (khử yếu hơn)."
    },
    {
        question: "(SBT – KNTT) Xét phản ứng: R + 2M⁺ → R²⁺ + 2M. Biết E°(M⁺/M) = x (V) và E°(R²⁺/R) = y (V). Nhận xét nào đúng?",
        img: "none",
        answers: [
            "x > y",
            "x < y",
        ...
        explain: "R khử M⁺ nên R có E° nhỏ hơn M, do đó x > y."
    },
    {
        question: "(Đề TN THPT QG – 2021) Kim loại nào sau đây có tính khử yếu hơn kim loại Cu?",
        img: "none",
        answers: [
            "Ag",
            "Zn",
        ...
        explain: "Ag có E° = +0,80 V > E°(Cu) = +0,34 V nên có tính khử yếu hơn Cu."
    },
    {
        question: "(Đề TN THPT QG – 2021) Kim loại nào sau đây có tính khử mạnh hơn kim loại Al?",
        img: "none",
        answers: [
            "Mg",
            "Fe",
        ...
        explain: "Mg có E° = −2,37 V < E°(Al) = −1,66 V nên tính khử mạnh hơn Al."
    },
    {
        question: "(Đề THPT QG – 2017) Kim loại nào sau đây có tính khử mạnh nhất?",
        img: "none",
        answers: [
            "K",
            "Fe",
        ...
        explain: "K có E° = −2,93 V, nhỏ nhất trong các kim loại đã cho, nên khử mạnh nhất."
    },
    {
        question: "(Đề MH – 2018) Kim loại nào sau đây có tính khử yếu nhất?",
        img: "none",
        answers: [
            "Ag",
            "Al",
        ...
        explain: "Ag có E° = +0,80 V lớn nhất → khó bị oxi hoá nhất → khử yếu nhất."
    },
    {
        question: "(Đề TN THPT QG – 2020) Ion kim loại nào sau đây có tính oxi hoá mạnh nhất?",
        img: "none",
        answers: [
            "Cu²⁺",
            "Mg²⁺",
        ...
        explain: "Cu²⁺ có E° = +0,34 V lớn hơn các ion khác nên có tính oxi hoá mạnh nhất."
    },
    {
        question: "(Đề TN THPT QG – 2021) Ion kim loại nào sau đây có tính oxi hoá yếu nhất?",
        img: "none",
        answers: [
            "Na⁺",
            "Cu²⁺",
        ...
        explain: "Na⁺ có E° = −2,71 V rất nhỏ → khó nhận e⁻ → oxi hoá yếu nhất."
    },
    {
        question: "(Đề TSCĐ – 2012) Cho dãy các ion: Fe²⁺, Ni²⁺, Cu²⁺, Sn²⁺. Ion có tính oxi hoá mạnh nhất là",
        img: "none",
        answers: [
            "Cu²⁺",
            "Sn²⁺",
        ...
        explain: "Cu²⁺ có E° = +0,34 V lớn nhất trong dãy → oxi hoá mạnh nhất."
    },
    {
        question: "Trong số các ion: Ag⁺, Al³⁺, Fe²⁺, Cu²⁺; ion nào có tính oxi hoá mạnh nhất ở điều kiện chuẩn?",
        img: "none",
        answers: [
            "Ag⁺",
            "Cu²⁺",
        ...
        explain: "Ag⁺ có E° = +0,80 V lớn nhất nên có tính oxi hoá mạnh nhất."
    },
    {
        question: "(SBT – CTST) Dãy kim loại sắp xếp theo chiều tăng dần tính khử từ trái sang phải là",
        img: "none",
        answers: [
            "Pb, Ni, Sn, Zn",
            "Pb, Sn, Ni, Zn",
        ...
        explain: "Pb, Ni, Sn, Zn có E° tăng dần → tính khử giảm dần → sắp xếp như trên."
    },
    {
        question: "Dãy cation kim loại được sắp xếp theo chiều tăng dần tính oxi hoá từ trái sang phải là",
        img: "none",
        answers: [
            "Mg²⁺, Fe²⁺, Cu²⁺",
            "Cu²⁺, Fe²⁺, Mg²⁺",
        ...
        explain: "E° tăng → oxi hoá tăng; Mg²⁺ < Fe²⁺ < Cu²⁺."
    },
    {
        question: "Cho các ion kim loại: Zn²⁺, Sn²⁺, Ni²⁺, Fe²⁺, Pb²⁺. Thứ tự tính oxi hoá giảm dần là",
        img: "none",
        answers: [
            "Pb²⁺ > Sn²⁺ > Ni²⁺ > Fe²⁺ > Zn²⁺",
            "Pb²⁺ > Sn²⁺ > Fe²⁺ > Ni²⁺ > Zn²⁺",
        ...
        explain: "Pb²⁺ có E° lớn nhất → oxi hoá mạnh nhất, Zn²⁺ nhỏ nhất → yếu nhất."
    },
    {
        question: "(SBT – CTST) Dãy các kim loại được sắp xếp theo chiều tính khử giảm dần là",
        img: "none",
        answers: [
            "K > Ca > Mg > Al > Fe > Cu",
            "Ca > K > Mg > Cu > Fe > Al",
        ...
        explain: "Tính khử giảm dần theo chiều E° tăng, nên thứ tự đúng là K > Ca > Mg > Al > Fe > Cu."
    }
]
                ...
                questions: [
    {
        ...
        ideas: [
            ...
            "b) Dạng oxi hoá và dạng khử của cùng một nguyên tố kim loại M: Mⁿ⁺ + nē → M tạo nên cặp oxi hoá – khử và kí hiệu là Mⁿ⁺/M.",
            "c) Trong một cặp oxi hoá – khử, dạng oxi hoá và dạng khử không phản ứng với nhau.",
            "d) Cùng một nguyên tố kim loại chỉ tạo được một cặp oxi hoá – khử."
        ],
        answers: ["Đúng", "Đúng", "Sai", "Sai"],
        img: "none",
        explain: "c) Fe + 2Fe³⁺ → 3Fe²⁺ là ví dụ phản ứng. d) Nguyên tố Fe tạo được 3 cặp oxi hoá – khử: Fe³⁺/Fe²⁺, Fe²⁺/Fe và Fe³⁺/Fe."
    },
    {
        question: "Câu 2: Mỗi phát biểu sau là đúng hay sai?",
        ideas: [
            "a) Trong phản ứng hoá học, cation kim loại (Mⁿ⁺) có thể nhận electron để trở thành nguyên tử kim loại (M) và ngược lại.",
            "b) Các kim loại có tính khử mạnh hơn sẽ khử được các cation của kim loại yếu hơn trong dung dịch muối.",
            "c) Trong dãy điện hoá, các cặp oxi hoá – khử được sắp xếp theo chiều tăng dần giá trị thế điện cực chuẩn E°.",
            "d) Mỗi phản ứng oxi hoá – khử đều có nhiều hơn một cặp oxi hoá – khử."
        ],
        answers: ["Đúng", "Sai", "Đúng", "Đúng"],
        img: "none",
        explain: "b) Na là kim loại mạnh nhưng không khử được Cu²⁺ do phản ứng mạnh với nước."
    },
    {
        question: "Câu 3: Xét phản ứng Ce⁴⁺ + 2I⁻ → I₂ + Ce³⁺.",
        ideas: [
            "a) Phương trình trên đã cân bằng.",
            "b) Chất oxi hoá là Ce⁴⁺, chất khử là I⁻.",
            "c) Cặp oxi hoá – khử của kim loại cerium là Ce⁴⁺/Ce, của iodine là I₂/2I⁻.",
            "d) Phương trình hoá học của phản ứng là: 2Ce⁴⁺ + 2I⁻ → I₂ + 2Ce³⁺."
        ],
        answers: ["Sai", "Đúng", "Sai", "Đúng"],
        img: "none",
        explain: "c) Cặp oxi hoá – khử của cerium là Ce⁴⁺/Ce³⁺, của iodine là I₂/2I⁻."
    },
    {
        question: "Câu 4: Ở điều kiện chuẩn, cho bột Cu dư vào dung dịch Fe₂(SO₄)₃ tới khi phản ứng hoàn toàn, thu được chất rắn X và dung dịch Y.",
        ideas: [
        ...
        answers: ["Sai", "Đúng", "Đúng", "Đúng"],
        img: "none",
        explain: "a) X chỉ chứa Cu. c) Cu dư nên Fe³⁺ hết, Y chỉ gồm Fe²⁺ và Cu²⁺."
    }
]
                ...
                questions: [
    {
        question: "Cho các phản ứng sau: (a) Zn(s) + Sn²⁺(aq), (b) Ag⁺(aq) + Fe(s), (c) Fe(s) + Mg²⁺(aq), (d) Au(s) + Cu²⁺(aq). Số phản ứng có thể tự xảy ra ở điều kiện chuẩn là bao nhiêu?",
        img: "none",
        answers: ["2"],
        explain: "Các phản ứng có thể tự phát là (a) và (b), tổng cộng 2 phản ứng."
    },
    {
        question: "Cho các phản ứng: (a) Mg²⁺(aq) + Pb(s) → Pb²⁺(aq) + Mg(s), (b) O₂(g) + 4H⁺(aq) + 2Zn(s) → 2H₂O(l) + 2Zn²⁺(aq), (c) Ni(s) + Sn²⁺(aq) → Ni²⁺(aq) + Sn(s), (d) Fe(s) + Mn²⁺(aq) → Fe²⁺(aq) + Mn(s). Những phản ứng nào không tự xảy ra ở điều kiện chuẩn?",
        img: "none",
        answers: ["2"],
        explain: "Các phản ứng không tự phát là (a) và (d), tổng cộng 2 phản ứng."
    },
    {
        question: "Có bốn dung dịch muối không màu: AgNO₃, Pb(NO₃)₂, Zn(NO₃)₂, Ni(NO₃)₂ được đựng trong bốn ống nghiệm riêng biệt. Cho thêm vào mỗi ống một sợi dây đồng. Sau một thời gian, số dung dịch chuyển màu xanh là bao nhiêu?",
        img: "none",
        answers: ["1"],
        explain: "Chỉ dung dịch AgNO₃ phản ứng với Cu tạo ion Cu²⁺ (màu xanh) và Ag kim loại bám lên dây đồng."
    },
    {
        question: "Cho các kim loại Cr, Ag, Cu, Mn và Zn. Số kim loại có thể được dùng để bảo vệ đường ống sắt khỏi bị gỉ là bao nhiêu?",
        img: "none",
        answers: ["3"],
        explain: "Các kim loại Cr, Mn và Zn có thế điện cực chuẩn nhỏ hơn Fe nên có thể bảo vệ sắt khỏi bị gỉ."
    }
]
